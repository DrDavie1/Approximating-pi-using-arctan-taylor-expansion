---------USING THE EXPANSION OF ARCTAN(X) TO APPROXIMATE PI---------
    ...
    Skills shown: Data Analysis, Data filtering, Error Catching, Data Visualisation, Mathematics. 

    -----------Running information-----------

    Simply run the main.py file and choose an option. 
